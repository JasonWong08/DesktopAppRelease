...
textEN = {
    ...
    'Send':'Send',
    'wifiWsConnect':'WiFi',
    'wifiWsConnected':'WiFi OK',
    'wifiIpInvalid':'Invalid IP address',
    'wifiWsNeedModule':'Please install websocket-client (pip install websocket-client)',
    'wifiWsFailed':'WebSocket connection failed',
    ...
    'Please connect to a serial port first':'Please connect to a serial port first',
    'Please select a serial port':'Please select a serial port',
...
textCN = {
    ...
    'Send':'发送',
    'wifiWsConnect':'WiFi',
    'wifiWsConnected':'WiFi已连接',
    'wifiIpInvalid':'IP 地址无效',
    'wifiWsNeedModule':'请安装 websocket-client（pip install websocket-client）',
    'wifiWsFailed':'WebSocket 连接失败',
    'Postures':'预设姿态',
    'balance': '站立',
    'buttUp': '撅屁股',
    'dropped': '下落',
    ...
    'Please connect to a serial port first':'请先连接到串口',
    'Please select a serial port':'请选择串口',
    'Connected to':'已连接到',
    'Disconnected from':'已断开',
    'Sent':'已发送',
    'Failed to send command':'发送指令失败',
    'Failed to copy':'复制失败',
    'Output cleared':'输出已清空',
    'Failed to open port':'无法打开端口',
...
textCN_TW = {
    ...
    'Please connect to a serial port first':'請先連接到串口',
    'Please select a serial port':'請選擇串口',
    'Connected to':'已連接到',
    'Disconnected from':'已斷開',
    'Sent':'已發送',
    'Failed to send command':'發送指令失敗',
    'Failed to copy':'複製失敗',
    'Output cleared':'輸出已清空',
    'Failed to open port':'無法打開端口',
...
textDE = {
    ...
    'Please connect to a serial port first':'Bitte zuerst eine serielle Schnittstelle verbinden',
    'Please select a serial port':'Bitte wählen Sie eine serielle Schnittstelle',
    ...
    'Output cleared':'Ausgabe gelöscht',
 ...
 * Sie können "N" wählen, um die Kalibrierungswerte beizubehalten. ''',
 ...
 Die Funktion dieser Taste ist dieselbe wie die Funktion der Taste "Aktualisieren Sie die Firmware".''',
    ...
    'msgVersion': 'Version: ' + versionNum + '\n' +
    '''Copyright © 2018-2026
Alle Rechte vorbehalten Petoi LLC
https://www.petoi.com\n''' + dateStr,
...
textTH = {
    ...
    'Show timestamp':'แสดงเวลา',
    'Clear output':'ล้างผลลัพธ์',
    'Error':'ข้อผิดพลาด',
    ...
    'Please connect to a serial port first':'โปรดเชื่อมต่อกับพอร์ตอนุกรมก่อน',
    'Please select a serial port':'โปรดเลือกพอร์ตอนุกรม',
    'Connected to':'เชื่อมต่อกับ',
    'Disconnected from':'ตัดการเชื่อมต่อจาก',
    'Sent':'ส่งแล้ว',
    'Failed to send command':'ไม่สามารถส่งคำสั่งได้',
    'Failed to copy':'คัดลอกไม่สำเร็จ',
    'Output cleared':'ล้างผลลัพธ์แล้ว',
    'Failed to open port':'ไม่สามารถเปิดพอร์ตได้',
...
textFR={
    ...
    'Please connect to a serial port first':'Veuillez d\'abord vous connecter à un port série',
    'Please select a serial port':'Veuillez sélectionner un port série',
    ...
    'Output cleared':'Sortie effacée',
    'Failed to open port':'Échec de l\'ouverture du port',
...
textJP={
    ...
    'Please connect to a serial port first':'まずシリアルポートに接続してください',
    'Please select a serial port':'シリアルポートを選択してください',
    'Connected to':'接続済み',
    'Disconnected from':'切断済み',
    'Sent':'送信済み',
    'Failed to send command':'コマンドの送信に失敗しました',
    'Failed to copy':'コピーに失敗しました',
    'Output cleared':'出力をクリアしました',
    'Failed to open port':'ポートを開けませんでした',
...
textIT = {
    ...
    'Please connect to a serial port first':'Si prega di connettersi prima a una porta seriale',
    'Please select a serial port':'Si prega di selezionare una porta seriale',
    'Connected to':'Connesso a',
    'Disconnected from':'Disconnesso da',
    'Sent':'Inviato',
    'Failed to send command':'Invio del comando non riuscito',
    'Failed to copy':'Copia non riuscita',
    'Output cleared':'Output cancellato',
    'Failed to open port':'Apertura porta non riuscita',
...
textRU = {
    ...
    'Please connect to a serial port first':'Пожалуйста, сначала подключитесь к последовательному порту',
    ...
    'Output cleared':'Вывод очищен',
    'Failed to open port':'Не удалось открыть порт',
...
Программа автоматически определит правильное имя последовательного порта.''',
    ...
    'Show timestamp':'Показать временную метку',
